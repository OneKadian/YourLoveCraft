                      ...
                      <ul className="py-2 text-md text-gray-700">
                        ...
                        >
                          <p className="block px-4 py-2 hover:bg-gray-100 cursor-pointer">
                            ...
                            character often has a rough exterior with a
                            sensitive or caring side that only the female lead
                            can bring out.
                          </p>
                        </li>
                        <li
                        ...
                        >
                          <p className="block px-4 py-2 hover:bg-gray-100 cursor-pointer">
                            ...
                            More approachable and down-to-earth, this character
                            is charming, relatable, and often more
                            straightforward than the typical "bad boy."
                          </p>
                        </li>
                        <li
                          onClick={() =>
                        ...
                        >
                          <p className="block px-4 py-2 hover:bg-gray-100 cursor-pointer">
                            ...
                            This character is supportive and loyal, often
                            leading to a slow-burn romance where friendship
                            blossoms into love.
                          </p>
                        </li>
                        <li
